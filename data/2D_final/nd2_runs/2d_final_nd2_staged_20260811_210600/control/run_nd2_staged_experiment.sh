...
for path in sorted(root.glob("runs/**/manifest.json")):
    try:
        ...
        print(
            ...
            f"completed={summary.get(chr(99)+chr(111)+chr(109)+chr(112)+chr(108)+chr(101)+chr(116)+chr(101)+chr(100)+chr(95)+chr(99)+chr(104)+chr(117)+chr(110)+chr(107)+chr(115))} "
            f"failed={summary.get(chr(102)+chr(97)+chr(105)+chr(108)+chr(101)+chr(100)+chr(95)+chr(99)+chr(104)+chr(117)+chr(110)+chr(107)+chr(115))} "
            f"pending={summary.get(chr(112)+chr(101)+chr(110)+chr(100)+chr(105)+chr(110)+chr(103)+chr(95)+chr(99)+chr(104)+chr(117)+chr(110)+chr(107)+chr(115))} "
            f"total={summary.get(chr(116)+chr(111)+chr(116)+chr(97)+chr(108)+chr(95)+chr(99)+chr(104)+chr(117)+chr(110)+chr(107)+chr(115))}"
        )
