...
cd /home/DATA1/users/yuany/.single_shot/repos/3d_toric_exp26b_fixed_p010_q000_100_20260426_nd2
...
master_run_root=/home/DATA1/users/yuany/.single_shot/runs/3d_toric_exp26b_fixed_p010_q000_100_20260426_nd2
...
while IFS='|' read -r syndrome_error_probability data_error_probabilities; do
  ...
  current_seed_base=$(( 2026042701 + q_index * 1000000000 ))
