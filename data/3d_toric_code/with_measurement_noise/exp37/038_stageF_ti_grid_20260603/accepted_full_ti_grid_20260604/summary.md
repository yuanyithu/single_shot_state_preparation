...
|---|---|---:|---|
| F1 | full grid present and every point has explicit PASS/WARN/FAIL; unresolved high-q_top tails are FAIL | coverage=True, unresolved=0, statuses=PASS:8, WARN:40 | PASS |
