...
cd /home/DATA1/users/yuany/.single_shot/repos/3d_toric_exp20a_q050_heavy_p018_022_20260425_nd1

if command -v python3 >/dev/null 2>&1; then
  q_and_p_windows="$(python3 -c 'import base64, sys; print(base64.b64decode(sys.argv[1]).decode(), end="")' MC4wNTAwfDAuMTgwMCwwLjE5MDAsMC4yMDAwLDAuMjEwMCwwLjIyMDA=)"
else
...
master_run_root=/home/DATA1/users/yuany/.single_shot/runs/3d_toric_exp20a_q050_heavy_p018_022_20260425_nd1
...
while IFS='|' read -r syndrome_error_probability data_error_probabilities; do
  ...
  current_seed_base=$(( 2026042520 + q_index * 1000000000 ))
