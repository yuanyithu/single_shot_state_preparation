...
cd /home/DATA1/users/yuany/.single_shot/repos/3d_toric_exp28a_fixed_p010_q000_100_L6_20260427_nd1

if command -v python3 >/dev/null 2>&1; then
  q_and_p_windows="$(python3 -c 'import base64, sys; print(base64.b64decode(sys.argv[1]).decode(), end="")' MC4wMDAwfDAuMTAwMAowLjAxMDB8MC4xMDAwCjAuMDIwMHwwLjEwMDAKMC4wMzAwfDAuMTAwMAowLjA0MDB8MC4xMDAwCjAuMDUwMHwwLjEwMDAKMC4wNjAwfDAuMTAwMAowLjA3MDB8MC4xMDAwCjAuMDgwMHwwLjEwMDAKMC4wOTAwfDAuMTAwMAowLjEwMDB8MC4xMDAw)"
else
...
master_run_root=/home/DATA1/users/yuany/.single_shot/runs/3d_toric_exp28a_fixed_p010_q000_100_L6_20260427_nd1
...
while IFS='|' read -r syndrome_error_probability data_error_probabilities; do
  ...
  current_seed_base=$(( 2026042811 + q_index * 1000000000 ))
