...
cd /home/DATA1/users/yuany/.single_shot/repos/3d_toric_exp24b_q001_q050_q100_p018_022_dense_20260426_nd2

if command -v python3 >/dev/null 2>&1; then
  q_and_p_windows="$(python3 -c 'import base64, sys; print(base64.b64decode(sys.argv[1]).decode(), end="")' MC4wNTAwfDAuMTgwLDAuMTg1LDAuMTkwLDAuMTk1LDAuMjAwLDAuMjA1LDAuMjEwLDAuMjE1LDAuMjIwCjAuMTAwMHwwLjE4MCwwLjE4NSwwLjE5MCwwLjE5NSwwLjIwMCwwLjIwNSwwLjIxMCwwLjIxNSwwLjIyMAowLjAxMDB8MC4xODAsMC4xODUsMC4xOTAsMC4xOTUsMC4yMDAsMC4yMDUsMC4yMTAsMC4yMTUsMC4yMjA=)"
else
...
master_run_root=/home/DATA1/users/yuany/.single_shot/runs/3d_toric_exp24b_q001_q050_q100_p018_022_dense_20260426_nd2
...
while IFS='|' read -r syndrome_error_probability data_error_probabilities; do
  ...
  current_seed_base=$(( 2026042602 + q_index * 1000000000 ))
