...
cd /home/DATA1/users/yuany/.single_shot/repos/3d_toric_exp20c_q050_heavy_p018_022_20260425_nd3
...
master_run_root=/home/DATA1/users/yuany/.single_shot/runs/3d_toric_exp20c_q050_heavy_p018_022_20260425_nd3
...
while IFS='|' read -r syndrome_error_probability data_error_probabilities; do
  ...
  current_seed_base=$(( 2026044520 + q_index * 1000000000 ))
