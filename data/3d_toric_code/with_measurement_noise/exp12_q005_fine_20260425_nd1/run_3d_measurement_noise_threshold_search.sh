...
cd /home/DATA1/users/yuany/.single_shot/repos/3d_toric_exp12_q005_fine_20260425_nd1

if command -v python3 >/dev/null 2>&1; then
  q_and_p_windows="$(python3 -c 'import base64, sys; print(base64.b64decode(sys.argv[1]).decode(), end="")' MC4wMDUwfDAuMjAwMCwwLjIwNTAsMC4yMTAwLDAuMjE1MCwwLjIyMDAsMC4yMjUwLDAuMjMwMCwwLjIzNTAsMC4yNDAwLDAuMjQ1MCwwLjI1MDA=)"
else
...
master_run_root=/home/DATA1/users/yuany/.single_shot/runs/3d_toric_exp12_q005_fine_20260425_nd1
...
while IFS='|' read -r syndrome_error_probability data_error_probabilities; do
  ...
  current_seed_base=$(( 2026042512 + q_index * 1000000000 ))
  ...
  if [[ -n 4000 ]]; then
    burn_in_cap_args+=(
      --max-effective-num-burn-in-sweeps 4000
    )
  fi
