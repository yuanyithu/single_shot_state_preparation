...
- `exp32_fixed_p050_q000_075_L34567_20260514_nd23`：已启动固定 `p=0.0500`、`q=0.0000~0.0750` 步长 `0.0050`、`L=3,4,5,6,7` 的 nd-2/nd-3 独立 seed 长扫描；每节点每 `(L,q)` `1024` disorder，池化目标为 `2048` disorder。当前是运行中实验，完成后再生成本地目录与结论。
