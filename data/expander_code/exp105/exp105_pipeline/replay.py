...
exp105 replays a preregistered ten percent of tasks rather than all of them.
...
REPLAY_SCHEMA = "exp105.replay.v1"
RESULT_FIELDS = {
...
def committed_replay_blocks(config):
    ...
    if policy["policy"] != "committed_random_subsample":
        raise ValueError("unexpected exp105 replay policy")
