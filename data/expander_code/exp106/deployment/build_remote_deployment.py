"""Build an immutable, selective exp106 remote source deployment.

exp104 is carried along because exp106 reuses its ensemble rule, its
...
than as a silent difference in what exp106 measures.
"""
...
from data.expander_code.exp106.exp106_pipeline.identity import (
    REMOTE_DEPLOYMENT_SCHEMA,
    source_tree_sha256,
)
from data.expander_code.exp106.exp106_pipeline.io import (
    atomic_json,
    canonical_json,
    sha256_file,
)
...
SOURCE_PATHS = (
    ...
    "data/expander_code/exp106/EXPERIMENT_CONTRACT.md",
    "data/expander_code/exp106/config",
    "data/expander_code/exp106/deployment/build_remote_deployment.py",
    "data/expander_code/exp106/deployment/bootstrap_verified_archive.sh",
    "data/expander_code/exp106/deployment/run_cost_benchmark.sh",
    "data/expander_code/exp106/deployment/run_remote_stage.sh",
    "data/expander_code/exp106/deployment/run_verified_source.sh",
    "data/expander_code/exp106/exp106_pipeline",
    "data/expander_code/exp106/final_results/README.md",
    "data/expander_code/exp106/raw/README.md",
    "data/expander_code/exp106/status.md",
    "data/expander_code/exp106/tests",
    "data/expander_code/exp106/validation",
)
...
FROZEN_EXECUTION_PATHS = (
    ...
    "data/expander_code/exp105/tests",
    "data/expander_code/exp106/EXPERIMENT_CONTRACT.md",
    "data/expander_code/exp106/deployment",
    "data/expander_code/exp106/exp106_pipeline",
    "data/expander_code/exp106/tests",
)
...
def build_remote_deployment(repo_root, output_dir, commit, config_path):
    ...
    if config["schema_version"] not in REMOTE_SCHEMAS:
        raise ValueError("remote deployment requires a canonical remote config")
    package_path = root / "data/expander_code/exp106/exp106_pipeline"
    if source_tree_sha256(package_path) != config["source_tree_sha256"]:
        raise ValueError("checked-out exp106 package differs from the frozen source tree")
    source_diff = _git(
