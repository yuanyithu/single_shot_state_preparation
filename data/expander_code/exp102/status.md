...
ordered ladder cells. Only m=3 passed, at `(p_hot=0.45,R=64)`; m=4..8 still failed at the maximum
configured `(p_hot=0.49,R=64)` candidate. Under the frozen policy, those m values must stop rather
than proceed to gamma/rounds/held-out. No `FROZEN_HELD_OUT_PASS` exists. Resuming requires an
explicitly reviewed pilot-contract change, such as expanding R or changing the ladder family.
