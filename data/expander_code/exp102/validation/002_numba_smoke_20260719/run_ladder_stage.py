...
def main():
    ...
    parser.add_argument("--p-hot", type=float, required=True)
    parser.add_argument("--num-temperatures", type=int, required=True)
    parser.add_argument("--gamma", type=float, required=True)
    parser.add_argument("--burn-rounds", type=int, required=True)
    parser.add_argument("--measurement-rounds", type=int, required=True)
        ...
        for p in p_values:
            for disorder in range(num_disorders):
                ...
                tasks.append((str(registry_path), str(config_path), str(output),
                              code["code_id"], p, disorder, candidate, args.attempt, args.stage))
