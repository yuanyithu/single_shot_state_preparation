...
CONTRACT_VERSION = "exp102.q0_bp_imh.local.v1"
REPORT_VERSION = "exp102.q0_bp_imh.local.report.v1"
TASK_VERSION = "exp102.q0_bp_imh.local.tasks.v1"
...
def _load_config(path):
    ...
    _require(set(config) == expected
             ...
             and config["config_version"] == "exp102.q0_bp_imh.local.config.v1",
    ...
    _require(config["seed_namespace"] == "exp102.q0_bp_imh.local.v1.20260724",
...
def _canonical_output_dir(output_dir):
