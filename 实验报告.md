...
- 保留原 `L=3` 单尺寸主入口为注释
- 新增多尺寸主入口，结果保存到
  `data/legacy_local_runs/baseline_multisize/scan_result_multi_L.npz`
...
- 结果文件改为新的命名，避免覆盖旧基线：
  - `data/legacy_local_runs/kernel_mix/scan_result_multi_L_kernel_mix.npz`
...
1. Smoke run
   ...
   - 文件：
     `data/legacy_local_runs/kernel_mix/scan_result_multi_L_kernel_mix_smoke.npz`
...
2. Threshold window run
   ...
   - 文件：
     `data/legacy_local_runs/kernel_mix/scan_result_multi_L_kernel_mix_focus.npz`
   - 关键结果：
...
3. Higher-p check
   ...
   - 文件：
     `data/legacy_local_runs/kernel_mix/scan_result_multi_L_kernel_mix_highp.npz`
   - 关键结果：
...
4. Far-right check
   ...
   - 文件：
     `data/legacy_local_runs/kernel_mix/scan_result_multi_L_kernel_mix_farhigh.npz`
   - 关键结果：
...
- 新 sampler 文件：
  - `data/legacy_local_runs/q0_geometric_multistart/scan_result_L7_q0_geometric_multistart_smoke.npz`
- 参数：
  - `p ∈ {0.10, 0.11, 0.12}`
...
- 文件：
  - 结果：
    `data/legacy_local_runs/q0_geometric_multistart/scan_result_multi_L_q0_geometric_multistart.npz`
  - 图像：
    `data/legacy_local_runs/q0_geometric_multistart/scan_result_multi_L_q0_geometric_multistart.png`
- 参数：
  - `lattice_size_list = [3, 5, 7]`
  - `syndrome_error_probability = 0.0`
...
- `q=0` 对照补跑结果：
  - `data/nd3_runs/q0_control_extension_20260421_225303/`
- 最终 `q>0` 大尺寸主任务归档：
  - `data/nd3_runs/no_threshold_final_20260421_225039/`
- 综合证据整理与作图输出：
  - `data/nd3_runs/no_threshold_evidence_20260422/`
...
- 新增综合分析目录 `data/nd3_runs/no_threshold_evidence_20260422/`，其中包含：
...
- 运行命令：
  - `scripts/run_local_3d_q0_smoke.sh`
- 输出目录：
  - `data/local_runs/3d_toric_q0_smoke_20260421_234202/`
- 运行参数：
...
- 本地归档目录：
  - `data/nd1_runs/3d_toric_q0_threshold_scout_20260421_235447/`
- 主要文件：
  - 结果：
    `data/nd1_runs/3d_toric_q0_threshold_scout_20260421_235447/scan_result_multi_L_3d_toric_q0_threshold_scout.npz`
  - 默认图：
    `data/nd1_runs/3d_toric_q0_threshold_scout_20260421_235447/scan_result_multi_L_3d_toric_q0_threshold_scout.png`
  - 95% CI 图：
    `data/nd1_runs/3d_toric_q0_threshold_scout_20260421_235447/scan_result_multi_L_3d_toric_q0_threshold_scout_sem95.png`
  - gap 图：
    `data/nd1_runs/3d_toric_q0_threshold_scout_20260421_235447/scan_result_multi_L_3d_toric_q0_threshold_scout_gap_crossing.png`
  - 本地重跑分析图：
    `data/nd1_runs/3d_toric_q0_threshold_scout_20260421_235447/scan_result_multi_L_3d_toric_q0_threshold_scout_local_sem95.png`
    `data/nd1_runs/3d_toric_q0_threshold_scout_20260421_235447/scan_result_multi_L_3d_toric_q0_threshold_scout_local_gap_crossing.png`
  - manifest：
    `data/nd1_runs/3d_toric_q0_threshold_scout_20260421_235447/manifest.json`
  - summary：
    `data/nd1_runs/3d_toric_q0_threshold_scout_20260421_235447/threshold_summary.json`
...
- `Stage A`：`nd-1` 右移 scout
  ...
  - 本地归档：
    `data/nd1_runs/3d_toric_q0_threshold_scout_20260422_100557_rightshift_stageA/`
- `Stage B`：`nd-3` extension scout
  ...
  - 本地归档：
    `data/nd3_runs/3d_toric_q0_threshold_scout_20260422_101018_extension_stageB_nd3/`
